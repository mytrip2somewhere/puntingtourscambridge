...
<figure class="infographic">
  ...
  <figcaption class="small">When to book versus turn up, and where the licensed stations sit.</figcaption>
</figure>

<aside class="infogain">
  <p class="infogain-h"><span class="tag">Latest data</span> How far ahead people are actually booking</p>
  <ul>
    <li>Viator Cambridge punting tours are booked, on average, about 10 days in advance.</li>
    <li>Shared punt tours listed on Tripadvisor are booked, on average, around 18 days ahead, so the planners reserve over two weeks out.</li>
    <li>The Conservators of the River Cam have licensed exactly six punting stations in the city, which is the full set of places you can legally pick up a shared punt.</li>
    <li>The recognised peak is Saturday and Sunday afternoons from May through September, when the Cam gets genuinely crowded.</li>
  </ul>
  <p class="infogain-note">A current snapshot, kept refreshed. These figures move with the season, so treat them as recent rather than fixed.</p>
</aside>
...
For what each option actually costs across the stations and operators, our [Cambridge punting prices guide](/guides/cambridge-punting-prices/) breaks it down, and you can weigh shared against private and chauffeured against self-punt on the [comparison page](/compare/).
...
You can confirm the licensing and the council's guidance on [Cambridge City Council's punting page](https://www.cambridge.gov.uk/punting), and the river authority itself, the [Conservators of the River Cam](https://www.camconservators.co.uk/), oversees who is allowed to operate. If you book a recognised shared tour ahead, this is handled for you, since you are routed to a licensed operator by default.
...
When you are ready to lock in a slot and see the current price, view the [Cambridge Shared Punting Tour](/tours/cambridge-shared-punting-tour/) and <a href="https://www.getyourguide.com/cambridge-england-l439/cambridge-shared-punting-tour-t137081/?partner_id=MME1WGW&utm_medium=online_publisher" rel="sponsored noopener" target="_blank">check live availability and prices</a> on the operator's official listing.
